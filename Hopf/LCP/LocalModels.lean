...
theorem SpecialPeriods.CuspFamily.cuspIntegralMatrix_toLin_eq_exchange (k : ℤ) :
    Matrix.toLin' (cuspIntegralMatrix k) =
      S6.SquareZeroExchange.exchange dualCuspN k := by
  ext x i
  fin_cases x <;> fin_cases i <;>
    norm_num [cuspIntegralMatrix, S6.SquareZeroExchange.exchange, dualCuspN, M₀,
...
theorem SpecialPeriods.CuspFamily.cuspIntegralMatrix_add (k l : ℤ) :
  ...
  exact (S6.SquareZeroExchange.exchange_mul_exchange dualCuspN_square_zero k l).symm
...
theorem SpecialPeriods.CuspFamily.cuspIntegralMatrix_real_toLin_eq_exchange (k : ℤ) :
    Matrix.toLin' ((cuspIntegralMatrix k).map (Int.castRingHom ℝ)) =
      S6.SquareZeroExchange.exchange dualCuspNReal (k : ℝ) := by
  apply LinearMap.ext
  intro x
  rw [S6.SquareZeroExchange.exchange_apply, dualCuspNReal_apply]
  ext i
  fin_cases i <;>
...
def SpecialPeriods.CuspFamily.cuspRealEquiv (k : ℤ) : RealPlane₄ ≃ₗ[ℝ] RealPlane₄ :=
  S6.SquareZeroExchange.exchangeEquiv dualCuspNReal dualCuspNReal_square_zero (k : ℝ)
...
theorem SpecialPeriods.CuspFamily.cuspRealEquiv_add_apply (k l : ℤ) (x : RealPlane₄) :
  ...
  simpa [cuspRealEquiv, Module.End.mul_apply] using
    DFunLike.congr_fun
      (S6.SquareZeroExchange.exchange_mul_exchange dualCuspNReal_square_zero
        (k : ℝ) (l : ℝ)).symm x
...
theorem SpecialPeriods.CuspFamily.cuspRealEquiv_neg (k : ℤ) :
  ...
  apply LinearEquiv.ext
  intro x
  change S6.SquareZeroExchange.exchange dualCuspNReal ((-k : ℤ) : ℝ) x =
    S6.SquareZeroExchange.exchange dualCuspNReal (-(k : ℝ)) x
  rw [Int.cast_neg]
