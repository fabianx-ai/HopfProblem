...
theorem SpecialPeriods.CuspFamily.cuspIntegralMatrix_toLin_eq_exchange (k : ℤ) :
    Matrix.toLin' (cuspIntegralMatrix k) =
      Lib.LinearAlgebra.SquareZeroExchange.exchange dualCuspN k := by
  ext x i
  fin_cases x <;> fin_cases i <;>
    norm_num [cuspIntegralMatrix, Lib.LinearAlgebra.SquareZeroExchange.exchange, dualCuspN, M₀,
...
theorem SpecialPeriods.CuspFamily.cuspIntegralMatrix_add (k l : ℤ) :
  ...
  exact (Lib.LinearAlgebra.SquareZeroExchange.exchange_mul_exchange
...
theorem SpecialPeriods.CuspFamily.cuspIntegralMatrix_real_toLin_eq_exchange (k : ℤ) :
    Matrix.toLin' ((cuspIntegralMatrix k).map (Int.castRingHom ℝ)) =
      Lib.LinearAlgebra.SquareZeroExchange.exchange dualCuspNReal (k : ℝ) := by
  apply LinearMap.ext
  intro x
  rw [Lib.LinearAlgebra.SquareZeroExchange.exchange_apply, dualCuspNReal_apply]
  ext i
  fin_cases i <;>
...
def SpecialPeriods.CuspFamily.cuspRealEquiv (k : ℤ) : RealPlane₄ ≃ₗ[ℝ] RealPlane₄ :=
  Lib.LinearAlgebra.SquareZeroExchange.exchangeEquiv
...
theorem SpecialPeriods.CuspFamily.cuspRealEquiv_add_apply (k l : ℤ) (x : RealPlane₄) :
  ...
  simpa [cuspRealEquiv, Module.End.mul_apply] using
    DFunLike.congr_fun
      (Lib.LinearAlgebra.SquareZeroExchange.exchange_mul_exchange dualCuspNReal_square_zero
        (k : ℝ) (l : ℝ)).symm x
...
theorem SpecialPeriods.CuspFamily.cuspRealEquiv_neg (k : ℤ) :
  ...
  apply LinearEquiv.ext
  intro x
  change Lib.LinearAlgebra.SquareZeroExchange.exchange dualCuspNReal ((-k : ℤ) : ℝ) x =
    Lib.LinearAlgebra.SquareZeroExchange.exchange dualCuspNReal (-(k : ℝ)) x
  rw [Int.cast_neg]
