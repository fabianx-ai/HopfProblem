...
structure AcyclicInDegreesOneTwo
    (Q : TopCat.Sheaf AddCommGrpCat.{u} X) : Prop where
  /-- The degree-one cohomology of `Q` vanishes. -/
  hOne : Subsingleton (CategoryTheory.Sheaf.H.{u} Q 1)
  /-- The degree-two cohomology of `Q` vanishes. -/
  hTwo : Subsingleton (CategoryTheory.Sheaf.H.{u} Q 2)
...
theorem hTwoMap_bijective_of_subsingleton_quotient
    ...
    [Subsingleton (CategoryTheory.Sheaf.H.{u} S.X₃ 2)] :
    Function.Bijective (CategoryTheory.Sheaf.H.map.{u} S.f 2) := by
  let P :=
...
def hTwoEquivMiddleOfSubsingletonQuotient
    ...
    [Subsingleton (CategoryTheory.Sheaf.H.{u} S.X₃ 1)]
    [Subsingleton (CategoryTheory.Sheaf.H.{u} S.X₃ 2)] :
    CategoryTheory.Sheaf.H.{u} S.X₁ 2 ≃+
      CategoryTheory.Sheaf.H.{u} S.X₂ 2 :=
  AddEquiv.ofBijective (CategoryTheory.Sheaf.H.map.{u} S.f 2)
...
def hTwoEquivMiddleOfAcyclicQuotient
    ...
    CategoryTheory.Sheaf.H.{u} S.X₁ 2 ≃+
      CategoryTheory.Sheaf.H.{u} S.X₂ 2 := by
  let _ := hQ.hOne
  let _ := hQ.hTwo
...
theorem hTwoEquivMiddleOfSubsingletonQuotient_apply
    ...
    [Subsingleton (CategoryTheory.Sheaf.H.{u} S.X₃ 1)]
    [Subsingleton (CategoryTheory.Sheaf.H.{u} S.X₃ 2)]
    (x : CategoryTheory.Sheaf.H.{u} S.X₁ 2) :
    hTwoEquivMiddleOfSubsingletonQuotient hS x =
      CategoryTheory.Sheaf.H.map.{u} S.f 2 x :=
  rfl
