...
/-!
# Transfer principles for strong local contractibility

This file proves that strong local contractibility can be checked on open neighborhoods and
descends through a surjective local homeomorphism.
-/
