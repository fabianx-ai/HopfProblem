...
disk one-point collapses, disk shrinking isotopies, and the sign of chart Jacobians in sphere
normal coordinates.  The positive transport of sphere points now lives in
