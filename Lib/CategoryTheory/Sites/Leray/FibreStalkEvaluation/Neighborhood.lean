...
sections. -/
def sectionsEquiv (G : TopCat.Sheaf AddCommGrpCat.{0} T) :
    ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G).obj.obj (op U) ≃+ G.obj.obj (op (⊤ : Opens T)) :=
...
theorem sectionsEquiv_naturality {F G : TopCat.Sheaf AddCommGrpCat.{0} T} (g : F ⟶ G)
    (s : ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj F).obj.obj (op U)) :
    sectionsEquiv i U hU G (((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).map g).hom.app (op U) s) =
...
def neighborhoodHomEquiv (G : TopCat.Sheaf AddCommGrpCat.{0} T) :
    (TopCat.ConstantSheaf.integralSheaf T ⟶ G) ≃
      (freeOpen U ⟶ (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) :=
  (TopCat.ConstantSheaf.integralHomGlobalEquiv T G).toEquiv.trans
    ((sectionsEquiv i U hU G).toEquiv.symm.trans
      (freeHomEquiv U ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G)).symm)

/-- The neighborhood morphism comparison preserves its represented section. -/
theorem neighborhoodHomEquiv_sections (G : TopCat.Sheaf AddCommGrpCat.{0} T)
    (a : TopCat.ConstantSheaf.integralSheaf T ⟶ G) :
    sectionsEquiv i U hU G
      (freeHomEquiv U ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) (neighborhoodHomEquiv i U hU G a)) =
        TopCat.ConstantSheaf.integralHomGlobalEquiv T G a := by
  change sectionsEquiv i U hU G
    (freeHomEquiv U ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G)
      ((freeHomEquiv U ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G)).symm
...
theorem neighborhoodHomEquiv_naturality {F G : TopCat.Sheaf AddCommGrpCat.{0} T}
    (a : TopCat.ConstantSheaf.integralSheaf T ⟶ F) (g : F ⟶ G) :
    neighborhoodHomEquiv i U hU G (a ≫ g) =
      neighborhoodHomEquiv i U hU F a ≫ (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).map g := by
  apply (freeHomEquiv U ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G)).injective
...
def neighborhoodUnit :
    freeOpen U ⟶ (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj (TopCat.ConstantSheaf.integralSheaf T) :=
...
theorem neighborhoodUnit_comp {G : TopCat.Sheaf AddCommGrpCat.{0} T}
    (a : TopCat.ConstantSheaf.integralSheaf T ⟶ G) :
    neighborhoodUnit i U hU ≫ (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).map a =
...
theorem neighborhoodUnit_bijective (G : TopCat.Sheaf AddCommGrpCat.{0} T) :
    Function.Bijective (fun a : TopCat.ConstantSheaf.integralSheaf T ⟶ G ↦
      neighborhoodUnit i U hU ≫ (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).map a) := by
...
cohomology. -/
def neighborhoodCohomologyForward (G : TopCat.Sheaf AddCommGrpCat.{0} T) (n : ℕ) :
    CategoryTheory.Sheaf.H.{0} G n →+
      CategoryTheory.Sheaf.H'.{0} ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) n U := by
  let _ := (pushforward_preservesFiniteLimitsAndColimits i hi hfinite).1
  let _ := pushforward_preservesFiniteColimits i hi hfinite
  exact Ext.ExactFunctorComparison.map (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i) (neighborhoodUnit i U hU) G n

/-- The neighborhood comparison is bijective in every degree. -/
theorem neighborhoodCohomologyForward_bijective (G : TopCat.Sheaf AddCommGrpCat.{0} T) (n : ℕ) :
    Function.Bijective (neighborhoodCohomologyForward i U hU hi hfinite G n) := by
  let _ := (pushforward_preservesFiniteLimitsAndColimits i hi hfinite).1
  let _ := pushforward_preservesFiniteColimits i hi hfinite
  let _ := pushforward_preservesInjectiveObjects i
  exact Ext.ExactFunctorComparison.map_bijective (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i)
...
def neighborhoodCohomologyEquiv (G : TopCat.Sheaf AddCommGrpCat.{0} T) (n : ℕ) :
    CategoryTheory.Sheaf.H'.{0} ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) n U ≃+
      CategoryTheory.Sheaf.H.{0} G n :=
...
theorem neighborhoodCohomologyForward_equiv (G : TopCat.Sheaf AddCommGrpCat.{0} T) (n : ℕ)
    (a : CategoryTheory.Sheaf.H'.{0} ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) n U) :
...
theorem sectionsEquiv_restrict (G : TopCat.Sheaf AddCommGrpCat.{0} T)
    (s : ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G).obj.obj (op V)) :
    sectionsEquiv i U hU G (((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G).obj.map r.op s) =
...
theorem neighborhoodHomEquiv_restrict (G : TopCat.Sheaf AddCommGrpCat.{0} T)
    (a : TopCat.ConstantSheaf.integralSheaf T ⟶ G) :
  ...
  have hfree :
      freeHomEquiv U ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G)
          ((freeOpenFunctor X).map r ≫ neighborhoodHomEquiv i V hV G a) =
        ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G).obj.map r.op
          (freeHomEquiv V ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G)
...
theorem neighborhoodCohomologyForward_restrict (G : TopCat.Sheaf AddCommGrpCat.{0} T) (n : ℕ)
    (a : CategoryTheory.Sheaf.H.{0} G n) :
    (CategoryTheory.Sheaf.cohomologyPresheaf ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) n).map r.op
  ...
  exact @comparison_precompose
    (TopCat.Sheaf AddCommGrpCat.{0} T) (TopCat.Sheaf AddCommGrpCat.{0} X) _ _ _ _
    (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i) (TopCat.Sheaf.pushforwardAdditive i)
...
theorem neighborhoodCohomologyEquiv_restrict (G : TopCat.Sheaf AddCommGrpCat.{0} T) (n : ℕ)
    (a : CategoryTheory.Sheaf.H'.{0} ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) n V) :
    neighborhoodCohomologyEquiv i U hU hi hfinite G n
      ((CategoryTheory.Sheaf.cohomologyPresheaf ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) n).map r.op a) =
...
variable {T X : TopCat.{0}} [T2Space T] (i : T ⟶ X)
  ...
  {F : TopCat.Sheaf AddCommGrpCat.{0} X} {G : TopCat.Sheaf AddCommGrpCat.{0} T} (κ : F ⟶ (TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G)
...
abbrev coefficientMap (n : ℕ) :
    CategoryTheory.Sheaf.cohomologyPresheaf F n ⟶
      CategoryTheory.Sheaf.cohomologyPresheaf ((TopCat.Sheaf.pushforward AddCommGrpCat.{0} i).obj G) n :=
