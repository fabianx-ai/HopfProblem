...
point fibre. -/
abbrev ConstantNormalization (A : AddCommGrpCat.{u})
...
def stalkToFibre (A : AddCommGrpCat.{u})
    (I : InjectiveResolution (TopCat.ConstantSheaf.sheaf X A)) (n : ℕ)
...
def neighborhoodGerm (A : AddCommGrpCat.{u})
    (I : InjectiveResolution (TopCat.ConstantSheaf.sheaf X A)) (n : ℕ)
...
restriction. -/
theorem stalkToFibre_neighborhoodGerm (A : AddCommGrpCat.{u})
    (I : InjectiveResolution (TopCat.ConstantSheaf.sheaf X A)) (n : ℕ)
    (ρ : ConstantNormalization f A I n) (U : Opens Y) (hy : y ∈ U) :
